...
const Dashboard = () => {
  ...
  const recentActivities = [
    { action: 'Dr. Smith updated patient #1042', time: '5 min ago', type: 'update' },
    { action: 'New lab result uploaded for #2031', time: '1 hour ago', type: 'lab' },
    { action: 'Prescription dispensed by Pharmacy', time: '2 hours ago', type: 'pharma' },
    { action: 'Patient #4412 registered by Reception', time: '3 hours ago', type: 'register' },
  ];

  const quickActions = [
    { name: 'Register Patient', icon: PlusCircleIcon, color: 'blue' },
    { name: 'New Appointment', icon: CalendarIcon, color: 'emerald' },
    { name: 'Create Record', icon: ClipboardDocumentCheckIcon, color: 'purple' },
    { name: 'View Audit Log', icon: DocumentMagnifyingGlassIcon, color: 'amber' },
  ];
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`w-2 h-2 rounded-full ${
                    ...
                    activity.type === 'pharma' ? 'bg-emerald-500' : 'bg-amber-500'
                  }`}></div>
